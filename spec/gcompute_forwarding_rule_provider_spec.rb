...
describe Puppet::Type.type(:gcompute_forwarding_rule).provider(:google) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gcompute_forwarding_rule { 'title1':
                  ensure                => present,
                ...
                gcompute_forwarding_rule { 'title2':
                  ensure                => present,
            ...
            context 'Gcompute_forwarding_rule[title1]' do
              subject do
                catalog.resource('Gcompute_forwarding_rule[title1]').provider
              end
            ...
            context 'Gcompute_forwarding_rule[title2]' do
              subject do
                catalog.resource('Gcompute_forwarding_rule[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_forwarding_rule[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_forwarding_rule).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  context '#exports' do
    context 'exports all properties' do
      ...
      let(:expected_results) do
        {
          self_link: 'selflink(resource(forwarding_rule,0))'
        }
      end
