...
describe Puppet::Type.type(:gcompute_backend_bucket).provider(:google) do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            ...
            context 'Gcompute_backend_bucket[title0]' do
              subject do
                catalog.resource('Gcompute_backend_bucket[title0]').provider
              end
            ...
            context 'Gcompute_backend_bucket[title1]' do
              subject do
                catalog.resource('Gcompute_backend_bucket[title1]').provider
              end
            ...
            context 'Gcompute_backend_bucket[title2]' do
              subject do
                catalog.resource('Gcompute_backend_bucket[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_backend_bucket[title0]').provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_backend_bucket).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gcompute_backend_bucket).provider(:google)
