...
describe Puppet::Type.type(:gcompute_instance_template).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gcompute_instance_template { 'title0':
                  ensure      => present,
                ...
                gcompute_instance_template { 'title1':
                  ensure      => present,
                ...
                gcompute_instance_template { 'title2':
                  ensure      => present,
            ...
            context 'Gcompute_instance_template[title1]' do
              subject do
                catalog.resource('Gcompute_instance_template[title1]').provider
              end
            ...
            context 'Gcompute_instance_template[title2]' do
              subject do
                catalog.resource('Gcompute_instance_template[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_instance_template[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_instance_template).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
