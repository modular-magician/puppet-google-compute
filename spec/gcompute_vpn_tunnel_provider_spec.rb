...
describe Puppet::Type.type(:gcompute_vpn_tunnel).provider(:google) do
  before(:all) do
        ...
        context 'title == name' do
          ...
          context 'title == name (pass)' do
            before do
              ...
              expect_network_get_success_target_vpn_gateway \
                1,
                region: 'test name#0 data'
              expect_network_get_success_target_vpn_gateway \
                2,
            ...
            let(:catalog) do
              apply_with_error_check(
                ...
                gcompute_target_vpn_gateway { 'resource(target_vpn_gateway,0)':
                  ensure     => present,
                  name       => 'test name#0 data',
                ...
                gcompute_target_vpn_gateway { 'resource(target_vpn_gateway,1)':
                  ensure     => present,
                  name       => 'test name#1 data',
                ...
                gcompute_target_vpn_gateway { 'resource(target_vpn_gateway,2)':
                  ensure     => present,
                  name       => 'test name#2 data',
            ...
            context 'Gcompute_vpn_tunnel[title0]' do
              subject do
                catalog.resource('Gcompute_vpn_tunnel[title0]').provider
              end
              ...
              # end
              it do
                is_expected.to have_attributes(router: 'test router#0 data')
              end
              it do
                is_expected.to have_attributes(peer_ip: 'test peer_ip#0 data')
              end
              it do
                is_expected
                  .to have_attributes(
              ...
              it do
                is_expected
                  .to have_attributes(
                    shared_secret_hash: 'test shared_secret_hash#0 data'
                  )
              end
              ...
              it do
                is_expected
                  .to have_attributes(
                    local_traffic_selector: %w[jj kk ll mm nn]
                  )
              end
              it do
                is_expected
                  .to have_attributes(remote_traffic_selector: %w[xx yy zz])
              end
            ...
            context 'Gcompute_vpn_tunnel[title1]' do
              subject do
                catalog.resource('Gcompute_vpn_tunnel[title1]').provider
              end
              ...
              # end
              it do
                is_expected.to have_attributes(router: 'test router#1 data')
              end
              it do
                is_expected.to have_attributes(peer_ip: 'test peer_ip#1 data')
              end
              it do
                is_expected
                  .to have_attributes(
              ...
              it do
                is_expected
                  .to have_attributes(
                    shared_secret_hash: 'test shared_secret_hash#1 data'
                  )
              end
              it { is_expected.to have_attributes(ike_version: 2) }
              it do
                is_expected
                  .to have_attributes(
                    local_traffic_selector: %w[vv ww xx yy zz]
                  )
              end
              it do
                is_expected
                  .to have_attributes(remote_traffic_selector: %w[ww xx yy zz])
              end
              # TODO(nelsonjr): Implement complex namevalues property test.
              # it 'labels' do
              #   # Add test code here
            ...
            context 'Gcompute_vpn_tunnel[title2]' do
              subject do
                catalog.resource('Gcompute_vpn_tunnel[title2]').provider
              end
              ...
              # end
              it do
                is_expected.to have_attributes(router: 'test router#2 data')
              end
              it do
                is_expected.to have_attributes(peer_ip: 'test peer_ip#2 data')
              end
              it do
                is_expected
                  .to have_attributes(
              ...
              it do
                is_expected
                  .to have_attributes(
                    shared_secret_hash: 'test shared_secret_hash#2 data'
                  )
              end
              it { is_expected.to have_attributes(ike_version: 2) }
              it do
                is_expected
                  .to have_attributes(local_traffic_selector: %w[gg hh ii jj])
              end
              it do
                is_expected
                  .to have_attributes(
                    remote_traffic_selector: %w[vv ww xx yy zz]
                  )
              end
              # TODO(nelsonjr): Implement complex namevalues property test.
              # it 'labels' do
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_vpn_tunnel[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gcompute_vpn_tunnel[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gcompute_vpn_tunnel).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end
  ...
  def expand_variables(template, data, extra_data = {})
    Puppet::Type.type(:gcompute_vpn_tunnel).provider(:google)
