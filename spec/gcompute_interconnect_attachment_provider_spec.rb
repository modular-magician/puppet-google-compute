...
describe Puppet::Type.type(:gcompute_interconnect_attachment)
                     .provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            context 'Gcompute_interconnect_attachment[title0]' do
              ...
              it do
                is_expected
                  .to have_attributes(
                    ...
                    'test cloud_router_ip_address#0 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    ...
                    'test customer_router_ip_address#0 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(interconnect: 'test interconnect#0 data')
              end
              it do
                is_expected
              ...
              it do
                is_expected
                  .to have_attributes(
                    google_reference_id: 'test google_reference_id#0 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    operational_status: 'test operational_status#0 data'
                  )
              end
              it do
            ...
            context 'Gcompute_interconnect_attachment[title1]' do
              subject do
                catalog.resource('Gcompute_interconnect_attachment[title1]')
                       .provider
              end
              ...
              it do
                is_expected
                  .to have_attributes(
                    cloud_router_ip_address:
                    'test cloud_router_ip_address#1 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    customer_router_ip_address:
                    'test customer_router_ip_address#1 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(interconnect: 'test interconnect#1 data')
              end
              it do
                is_expected
              ...
              it do
                is_expected
                  .to have_attributes(
                    google_reference_id: 'test google_reference_id#1 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    operational_status: 'test operational_status#1 data'
                  )
              end
              it do
            ...
            context 'Gcompute_interconnect_attachment[title2]' do
              subject do
                catalog.resource('Gcompute_interconnect_attachment[title2]')
                       .provider
              end
              ...
              it do
                is_expected
                  .to have_attributes(
                    cloud_router_ip_address:
                    'test cloud_router_ip_address#2 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    customer_router_ip_address:
                    'test customer_router_ip_address#2 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(interconnect: 'test interconnect#2 data')
              end
              it do
                is_expected
              ...
              it do
                is_expected
                  .to have_attributes(
                    google_reference_id: 'test google_reference_id#2 data'
                  )
              end
              it do
                is_expected
                  .to have_attributes(
                    operational_status: 'test operational_status#2 data'
                  )
              end
              it do
  ...
  context '#exports', broken: true do
    context 'exports all properties' do
      ...
      let(:expected_results) do
        {
          self_link: 'selflink(resource(interconnect_attachment,0))'
        }
      end
    ...
    URI.join(
      ...
      expand_variables(
        [
          ...
          '{{region}}/interconnectAttachments/{{name}}',
        ].join('/'),
        data
      )
    )
