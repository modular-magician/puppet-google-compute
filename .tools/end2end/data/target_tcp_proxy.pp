...
#       puppet apply .tools/end2end/data/target_tcp_proxy.pp
#
...
gcompute_backend_service { 'puppet-e2e-my-tcp-backend':
  ensure        => present,
  backends      => [
...
gcompute_target_tcp_proxy { 'puppet-e2e-my-tcp-proxy':
  ensure       => present,
  proxy_header => 'PROXY_V1',
  service      => 'puppet-e2e-my-tcp-backend',
  project      => $project, # e.g. 'my-test-project'
  credential   => 'mycred',
}
