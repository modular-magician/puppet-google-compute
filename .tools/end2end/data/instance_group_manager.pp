...
#       puppet apply .tools/end2end/data/instance_group_manager.pp
#
...
gcompute_instance_group_manager { 'puppet-e2e-test1':
  ensure             => present,
  base_instance_name => 'puppet-e2e-test1-child',
  instance_template  => 'puppet-e2e-instance-template',
  target_size        => 3,
  zone               => 'us-west1-a',
  project            => $project, # e.g. 'my-test-project'
  credential         => 'mycred',
