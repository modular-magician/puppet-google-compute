...
Puppet::Type.type(:gcompute_route).provide(:google) do
  ...
  def resource_to_request
    request = {
      ...
      priority: @resource[:priority],
      tags: @resource[:tags],
      nextHopGateway: @resource[:next_hop_gateway],
      nextHopInstance: @resource[:next_hop_instance],
      nextHopIp: @resource[:next_hop_ip],
      nextHopVpnTunnel: @resource[:next_hop_vpn_tunnel],
      nextHopNetwork: @resource[:next_hop_network]
    }.reject { |_, v| v.nil? }
