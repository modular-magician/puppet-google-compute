...
Puppet::Type.type(:gcompute_router).provide(:google) do
  mk_resource_methods
  ...
  def self.prefetch(resources)
    ...
    resources.each do |name, resource|
      ...
      fetch = fetch_resource(resource, self_link(resource), 'compute#router')
      resource.provider = present(name, fetch, resource) unless fetch.nil?
      Google::ObjectStore.instance.add(:gcompute_router, resource)
    end
  end
