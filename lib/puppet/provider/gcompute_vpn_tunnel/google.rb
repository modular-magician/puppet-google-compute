  ...
  def self.fetch_to_hash(fetch, resource)
    {
      ...
      shared_secret: Google::Compute::Property::String.api_munge(fetch['sharedSecret']),
      shared_secret_hash: Google::Compute::Property::String.api_munge(fetch['sharedSecretHash']),
      ike_version: Google::Compute::Property::Integer.api_munge(fetch['ikeVersion']),
