...
Puppet::Type.type(:gcompute_zone).provide(:google) do
  mk_resource_methods
  ...
  def self.prefetch(resources)
    ...
    resources.each do |name, resource|
      ...
      fetch = fetch_resource(resource, self_link(resource), 'compute#zone')
      resource.provider = present(name, fetch) unless fetch.nil?
      Google::ObjectStore.instance.add(:gcompute_zone, resource)
    end
  end
