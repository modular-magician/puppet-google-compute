...
Puppet::Type.type(:gcompute_interconnect_attachment).provide(:google) do
  mk_resource_methods
  ...
  def self.prefetch(resources)
    ...
    resources.each do |name, resource|
      ...
      Google::ObjectStore.instance.add(:gcompute_interconnect_attachment, resource)
    end
  end
  ...
  def self.fetch_to_hash(fetch)
    {
      cloud_router_ip_address: Google::Compute::Property::String.api_munge(
        fetch['cloudRouterIpAddress']
      ),
      customer_router_ip_address: Google::Compute::Property::String.api_munge(
        fetch['customerRouterIpAddress']
      ),
      interconnect:
        Google::Compute::Property::String.api_munge(fetch['interconnect']),
      description:
        Google::Compute::Property::String.api_munge(fetch['description']),
      private_interconnect_info:
        Google::Compute::Property::InteAttaPrivInteInfo.api_munge(
          fetch['privateInterconnectInfo']
        ),
      google_reference_id:
        Google::Compute::Property::String.api_munge(fetch['googleReferenceId']),
      operational_status:
        Google::Compute::Property::String.api_munge(fetch['operationalStatus']),
      router: Google::Compute::Property::String.api_munge(fetch['router']),
      creation_timestamp:
