...
Puppet::Type.type(:gcompute_interconnect_attachment).provide(:google) do
  ...
  def self.prefetch(resources)
    ...
    resources.each do |name, resource|
      ...
      fetch = fetch_resource(resource, self_link(resource), 'compute#interconnectAttachment')
  ...
  def self.fetch_to_hash(fetch)
    {
      cloud_router_ip_address:
        Google::Compute::Property::String.api_munge(fetch['cloudRouterIpAddress']),
      customer_router_ip_address:
        Google::Compute::Property::String.api_munge(fetch['customerRouterIpAddress']),
      ...
      private_interconnect_info:
        Google::Compute::Property::InteAttaPrivInteInfo.api_munge(fetch['privateInterconnectInfo']),
      google_reference_id: Google::Compute::Property::String.api_munge(fetch['googleReferenceId']),
      operational_status: Google::Compute::Property::String.api_munge(fetch['operationalStatus']),
