...
Puppet::Type.newtype(:gcompute_router) do
  @doc = 'Represents a Router resource.'
  ...
  newparam(:region, parent: Google::Compute::Property::RegionNameRef) do
    desc 'Region where the router resides.'
  end
  ...
  newproperty(:bgp, parent: Google::Compute::Property::RouterBgp) do
    desc 'BGP information specific to this router.'
  end
