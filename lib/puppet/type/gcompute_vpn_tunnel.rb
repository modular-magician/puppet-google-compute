...
Puppet::Type.newtype(:gcompute_vpn_tunnel) do
  ...
  newproperty(:target_vpn_gateway,
              parent: Google::Compute::Property::TarVpnGatSelLinRef) do
    desc <<-DOC
  ...
  newproperty(:local_traffic_selector,
              parent: Google::Compute::Property::StringArray) do
    desc <<-DOC
  ...
  newproperty(:remote_traffic_selector,
              parent: Google::Compute::Property::StringArray) do
    desc <<-DOC
