...
Puppet::Type.newtype(:gcompute_interconnect_attachment) do
  ...
  newparam(:region, parent: Google::Compute::Property::RegioSelfLinkRef) do
  ...
  newproperty(:cloud_router_ip_address, parent: Google::Compute::Property::String) do
    desc <<-DOC
      ...
      this interconnect attachment. (output only)
    DOC
  end
  ...
  newproperty(:customer_router_ip_address, parent: Google::Compute::Property::String) do
    desc <<-DOC
      ...
      subinterface for this interconnect attachment. (output only)
    DOC
  end
  ...
  newproperty(:private_interconnect_info,
              parent: Google::Compute::Property::InteAttaPrivInteInfo) do
    desc <<-DOC
      [Output Only] Information specific to an InterconnectAttachment. This property is populated
      if the interconnect that this is attached to is of type DEDICATED. (output only)
    DOC
  end
  ...
  newproperty(:google_reference_id, parent: Google::Compute::Property::String) do
    desc <<-DOC
      ...
      otherwise to debug backend connectivity issues. (output only)
    DOC
  end

  newproperty(:operational_status, parent: Google::Compute::Property::String) do
    desc <<-DOC
      [Output Only] The current status of whether or not this interconnect attachment is
      functional. (output only)
    DOC
  end
  ...
  newproperty(:creation_timestamp, parent: Google::Compute::Property::Time) do
    desc '[Output Only] Creation timestamp in RFC3339 text format. (output only)'
  end
