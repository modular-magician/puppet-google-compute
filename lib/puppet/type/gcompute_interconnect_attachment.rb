...
Puppet::Type.newtype(:gcompute_interconnect_attachment) do
  ...
  newproperty(:cloud_router_ip_address,
              parent: Google::Compute::Property::String) do
    desc <<-DOC
      [Output Only] IPv4 address + prefix length to be configured on Cloud
      Router Interface for this interconnect attachment. (output only)
    DOC
  end

  newproperty(:customer_router_ip_address,
              parent: Google::Compute::Property::String) do
    desc <<-DOC
      [Output Only] IPv4 address + prefix length to be configured on the
      customer router subinterface for this interconnect attachment. (output
      only)
    DOC
  end
  ...
  newproperty(:private_interconnect_info,
    ...
    desc <<-DOC
      ...
      type DEDICATED. (output only)
    DOC
  end

  newproperty(:google_reference_id,
              parent: Google::Compute::Property::String) do
    desc <<-DOC
  ...
  newproperty(:operational_status, parent: Google::Compute::Property::String) do
    desc <<-DOC
      ...
      attachment is functional. (output only)
    DOC
  end
