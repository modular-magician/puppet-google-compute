...
Puppet::Type.newtype(:gcompute_url_map) do
  @doc = <<-DOC
    UrlMaps are used to route requests to a backend service based on rules that you define for the
  ...
  newproperty(:host_rules, parent: Google::Compute::Property::UrlMapHostrulesArray) do
