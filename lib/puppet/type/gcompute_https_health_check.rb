...
Puppet::Type.newtype(:gcompute_https_health_check) do
  @doc = <<-DOC
    An HttpsHealthCheck resource. This resource defines a template for how individual VMs should be
    checked for health, via HTTPS.
  DOC
  ...
  newparam(:name, namevar: true) do
    ...
    desc 'The name of the HttpsHealthCheck.'
  end
  ...
  newproperty(:port, parent: Google::Compute::Property::Integer) do
    desc 'The TCP port number for the HTTPS health check request. The default value is 80.'
  end

  newproperty(:request_path, parent: Google::Compute::Property::String) do
    desc 'The request path of the HTTPS health check request. The default value is /.'
  end
