      ...
      class RegionSelfLinkRefCatalog < RegionSelfLinkRef
        ...
        def resource
          ...
          unless /https:\/\/www.googleapis.com\/compute\/v1\/projects\/.*\/regions\/[a-z1-9\-]*/.match(@title)
            ...
            return "https://www.googleapis.com/compute/v1/projects/#{@resource.parameters[:project].value.to_s}/regions/#{@title}"
          end
    ...
    module Property
      ...
      class RegionSelfLinkRef < Puppet::Property
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          Data::RegionSelfLinkRefCatalog.new(value, resource)
        end
