...
module Google
  module Compute
    ...
    module Property
      ...
      class SslCertificateSelflinkRef < Puppet::Property
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          Data::SslCertificateSelflinkRefCatalog.new(value, resource)
        end
      ...
      class SslCertificateSelflinkRefArray < Google::Compute::Property::Array
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          return SslCertificateSelflinkRef.unsafe_munge(value) \
            unless value.is_a?(::Array)
          value.map { |v| SslCertificateSelflinkRef.unsafe_munge(v, resource) }
        end

        # Used for parsing GCP API responses
        def self.api_munge(value)
          return if value.nil?
          return SslCertificateSelflinkRef.api_munge(value) \
            unless value.is_a?(::Array)
          value.map { |v| SslCertificateSelflinkRef.api_munge(v) }
        end
      end
    end
  end
