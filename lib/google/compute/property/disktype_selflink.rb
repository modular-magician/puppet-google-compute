...
module Google
  module Compute
      ...
      class DiskTypeSelfLinkRefCatalog < DiskTypeSelfLinkRef
        ...
        def resource
          ...
          unless /https:\/\/www.googleapis.com\/compute\/v1\/projects\/.*\/zones\/{{zone}}\/diskTypes\/[a-z1-9\-]*/.match(@title)
            ...
            return "https://www.googleapis.com/compute/v1/projects/#{@resource.parameters[:project].value.to_s}/zones/#{@resource.parameters[:zone].value.to_s}/diskTypes/#{@title}"
          end
    ...
    module Property
      ...
      class DiskTypeSelfLinkRef < Puppet::Property
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          Data::DiskTypeSelfLinkRefCatalog.new(value, resource)
        end
