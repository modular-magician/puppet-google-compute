        ...
        def resource
          ...
          unless /https:\/\/www.googleapis.com\/compute\/v1\/projects\/.*\/zones\/[a-z1-9\-]*\/diskTypes\/[a-z1-9\-]*/.match(@title)
            ...
            projects = Google::ObjectStore.instance
                                          ...
                                          .compact
                                          .uniq
            return "https://www.googleapis.com/compute/v1/projects/#{projects[0]}/zones/{{zone}}/diskTypes/#{@title}" \
            ...
            raise ["Your Puppet manifest contains multiple projects.",
                   ...
                   "https://www.googleapis.com/compute/v1/projects/{{project}}/zones/{{zone}}/diskTypes/{{name}}"
                  ].join(' ')
          end
