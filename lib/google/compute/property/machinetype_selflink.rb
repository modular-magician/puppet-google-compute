      ...
      class MachineTypeSelfLinkRefCatalog < MachineTypeSelfLinkRef
        ...
        def resource
          ...
          unless /https:\/\/www.googleapis.com\/compute\/v1\/projects\/.*\/zones\/{{zone}}\/machineTypes\/[a-z1-9\-]*/.match(@title)
            ...
            return "https://www.googleapis.com/compute/v1/projects/#{@resource.parameters[:project].value.to_s}/zones/#{@resource.parameters[:zone].value.to_s}/machineTypes/#{@title}"
          end
