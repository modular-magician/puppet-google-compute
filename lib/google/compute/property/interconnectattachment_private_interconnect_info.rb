  ...
  module Compute
    module Data
      ...
      class InteAttaPrivInteInfoApi < InteAttaPrivInteInfo
        def initialize(args)
          @tag8021q =
            Google::Compute::Property::Integer.api_munge(args['tag8021q'])
        end
      end
      ...
      class InteAttaPrivInteInfoCatalog < InteAttaPrivInteInfo
        def initialize(args)
          @tag8021q =
            Google::Compute::Property::Integer.unsafe_munge(args['tag8021q'])
        end
      end
    end
    ...
    module Property
      ...
      # interconnect_attachment.
      class InteAttaPrivInteInfo < Google::Compute::Property::Base
